...
export default function Detail() {
  ...
  const dataDetail = useContext(ContainerContext);
  const { detailList, onCart, onIncrement, onDecrement } = dataDetail;

  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
// useEffect(()=>{
//     const newList = JSON.parse(localStorage.getItem('listDetail'))
// },[])
  return (
    <div>
      <Header />
      <div className="Detail">
        <div className="Detail_wrapper">
          <div className="Detail_Nav">
            <ul>
              <li>Trang chủ</li>
              <li>Sinh nhật TokyoLift</li>
              <li className="Detail_nav-name">{detailList.name}</li>
            </ul>
          </div>
          <div className="Detail_Content">
            <div className="Detail_Content-ListImg">
              <div className="Detail_Content-ListImg-left">
                {detailList.image.map((item, index) => {
                  return (
                    <img
                      src={item}
              ...
              <div className="Detail_Content-ListImg-right">
                <img src={detailList.image[0]} alt="" />
              </div>
            </div>
            <div className="Detail_Content-Description">
              <div className="Detail_Description">
                <div className="Detail_Description-title">
                  <h2>{detailList.name}</h2>
                  <p>{detailList.code}</p>
                </div>
                <div className="Detail_Description-Price">
                  <div className="Detail_Description-Price-Top">
                    <div className="Detail_Description-PriceTwo">
                      <span className="Description-Price-New">
                        {detailList.price} đ
                      </span>
                      <span className="Description-Price-Old">
                        {detailList.old_price}
                      </span>
                    </div>
                    <div className="Detail_Description-Status">
                      <p>{detailList.status}</p>
                      <svg
                        width="17"
                        height="17"
                        viewBox="0 0 17 17"
                  ...
                  <div className="Detail_Description-Price-Bottom">
                    Giảm {detailList.sale}
                  </div>
                </div>
                <div className="Detail_Description-private">
                  <div>
                    <img
                      src="https://tokyolife.vn/sale-online.svg"
                      alt=""
                    />
                    <p>Giá độc quyền website</p>
                  </div>
                </div>
                <div className="Detail_Description-border"></div>
                <div className="Detail_Description-Size">
                  <div>Kích Thước</div>
                  <div className="Detail_Description-SizeList">
                    {detailList.size.map((item, index) => {
                      return <span key={index}>{item}</span>;
                    })}
                  </div>
                </div>
                <div className="Detail_Description-Add-To-Cart">
                  <div className="Detail_Description-Add-Title">
                    Chọn Số Lượng
                  </div>
                  <div className="Detail_Description-AddList-Number">
                    <span
                      className="Detail_Description-Delete"
                      onClick={() => onDecrement(detailList)}
                    >
                      -
                    </span>
                    <span className="Detail_Description-Number">
                      {detailList.quantity}
                    </span>
                    <span
                      className="Detail_Description-Add"
                      onClick={() => onIncrement(detailList)}
                    >
                      +
                    </span>
                  </div>
                </div>
                <div className="Detail_Description-InstructSize">
                  <svg
                    width="25"
                    height="10"
                    viewBox="0 0 25 10"
                ...
                <div className="Detail_Description-Buy">
                  <div className="Detail_Description-Buy-Add">
                    <div
                      className="Detail_Description-Cart"
                      onClick={() => onCart(detailList)}
                    >
                      <svg
                        width="25"
                        height="24"
                    ...
                    <Link
                      to="/Cart"
                      className="Detail_Description-link"
                    >
                      <div className="Detail_Description-Buybuy">
                        <svg
                          width="18"
                          height="21"
                          viewBox="0 0 18 21"
                  ...
                  <div className="Detail_Description-Market">
                    <svg
                      width="19"
                      height="18"
                      viewBox="0 0 19 18"
                    ...
                    <span>Cửa hàng chưa có sản phẩm</span>
                  </div>
                </div>
                <div className="Detail_Description_space"></div>
                <div className="Detail_Description-Bottoms">
                  <div>
                    <svg
                      width="43"
                      height="29"
